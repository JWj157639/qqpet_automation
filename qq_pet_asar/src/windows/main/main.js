              ...
              windowsMain
                .open({
                      ...
                      (global.doMovePosition = (e) => {
                        if (e?.toPosition)
                          ...
                          for (let o in n.nowPosition)
                            n.nowPosition[o] <= 0
                              ? ((n.nowPosition[o] = 0), (t[o] = 0))
                              : n.nowPosition[o] >=
                                  getScreenSize()[o] - e.maxSize[0] &&
                                ((n.nowPosition[o] =
                                  getScreenSize()[o] - e.maxSize[0]),
                                (t[o] = 0));
                        }
                      ...
                      a({
                              ...
                              (global.openSpeak = (e) => {
                                ...
                                if (!getSys("doNotDisturb") || o?.mustSpeak) {
                                  if (
                                    ...
                                    let e = getCommunication(...s);
                                    e?.tolk &&
                                      ((o.data = e.tolk),
                                      (o.submitText = e?.submitText || ""));
                                  }
                                  (t.webContents.send("main_bus-html_active", {
                                    active: n || "speak",
                                    type: i || "speak",
                        ...
                        main_h_setPetState_m: (e, t) => {
                          ...
                          if (
                            ...
                            let e = getCommunication(t.data.tolkName || "");
                            e &&
                              (t.data?.tolkActive
                                ? openSpeak({
                                    data: {
                  ...
                  onload(e) {
                    ...
                    (n.menu.addTrays(t),
                      n.menu?.activeTraysIcon && i && n.menu.activeTraysIcon(i),
                      i && (i = null));
                    let o = null;
                    ((global.addGoods = (e, t) => {
